...
[![Docs](https://img.shields.io/badge/PDFs-46%20bilingual-blue)]()
...
| 📚 **採購決策者 / 顧問**<br>Buyer decider / Consultant | 我要看**文件 / 報價 / 規格書**<br>I need **docs / quotes / specs** | 👉 [**46 份雙語 PDF**](#-46-份雙語客戶文件--46-bilingual-customer-pdfs) |
...
- [📚 46 份雙語客戶文件 / 46 Bilingual PDFs](#-46-份雙語客戶文件--46-bilingual-customer-pdfs)
...
## 📚 46 份雙語客戶文件 / 46 Bilingual Customer PDFs
...
│   ├── index.html
│   └── Dockerfile
├── docs/                       ← 46 份雙語文件 / 46 bilingual docs
