...
[![Docs](https://img.shields.io/badge/PDFs-44%20bilingual-blue)]()
...
| 📚 **採購決策者 / 顧問**<br>Buyer decider / Consultant | 我要看**文件 / 報價 / 規格書**<br>I need **docs / quotes / specs** | 👉 [**44 份雙語 PDF**](#-44-份雙語客戶文件--44-bilingual-customer-pdfs) |
...
- [📚 44 份雙語客戶文件 / 44 Bilingual PDFs](#-44-份雙語客戶文件--44-bilingual-customer-pdfs)
...
## 📚 44 份雙語客戶文件 / 44 Bilingual Customer PDFs
...
│   ├── index.html
│   └── Dockerfile
├── docs/                       ← 44 份雙語文件 / 44 bilingual docs
