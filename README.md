...
[![Docs](https://img.shields.io/badge/PDFs-52%20bilingual-blue)]()
...
| 📚 **採購決策者 / 顧問**<br>Buyer decider / Consultant | 我要看**文件 / 報價 / 規格書**<br>I need **docs / quotes / specs** | 👉 [**52 份雙語 PDF**](#-52-份雙語客戶文件--52-bilingual-customer-pdfs) |
...
- [📚 52 份雙語客戶文件 / 52 Bilingual PDFs](#-52-份雙語客戶文件--52-bilingual-customer-pdfs)
...
## 📚 52 份雙語客戶文件 / 52 Bilingual Customer PDFs
...
│   ├── index.html
│   └── Dockerfile
├── docs/                       ← 52 份雙語文件 / 52 bilingual docs
