...
>
> **v3.0 核心承諾**：本系統是 **桌機對話式 ERP**——員工在辦公室打開 Chrome，用桌機 Chat 一句話完成所有 CRUD。主廠資料留在主廠、MESH 多廠資料不外流。所有網路設計都圍繞這個核心。

> ⚡ **v3.0 戰略軸轉通知（2026-05-15）**
> 「LINE Bot Webhook：讓 LINE 找到您」整段（原 §6 或類似章節）於 v3.0 下架。
> 「外協廠用 LINE 不註冊」「業務手機隨身查」相關描述為 v2 舊版內容，請以本 banner 為準。
