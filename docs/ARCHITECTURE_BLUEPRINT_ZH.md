# Ouvoca 系統架構藍圖（繁體中文）— v3.0

> **給 IT 主管 / 系統架構師 / 資安顧問**
> 從 1 個客戶到 1000 個客戶，這個系統要怎麼長？
> 防禦縱深、HA、災備、可觀測性 — 全部攤開。

> ⚡ **v3.0 戰略軸轉通知**：Port matrix / 部署圖可能仍顯示 Expo (8081)、LINE Webhook (TLS) 等舊埠。
> v3.0 已砍 mobile / LINE。實際部署只需開：80/443（Web）/ 5432（PostgreSQL）/ 6379（Redis）/ 9000-9001（MinIO）。
